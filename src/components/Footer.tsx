...
const Footer = () =>{
    return (
        <div id="footer">
            ...
            <footer className="flex bg-black flex-col w-full mt-10">
                <MainFooter/>
         ...
         <Image className="cursor-pointer" src={"/Ikeja_FC_Logo.png"} alt={'Ikeja_Logo'} title={'Ikeja'} width={100} height={100}/>
                    <div className="flex flex-col lg:items-end md:items-end sm:items-center xl:items-end">
                        <Image className="my-5 cursor-pointer" src={"/LiiGi.jpg"} alt={'LiiGi_Logo'} title={'LiiGi'} width={80} height={80}/>
                        <p className={`${montserrat.className} text-md text-white py-2`}>© 2024 Liigi. All rights reserved.</p>
                    </div>
                </div>
            </footer>
