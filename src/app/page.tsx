import { Carousel, NewsList, Footer, ImageSlider } from "../components"
...
export default function Home() {
    const images = [
        "https://images.unsplash.com/photo-1522778119026-d647f0596c20?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        ...
        "https://images.unsplash.com/photo-1516731566880-919c39006c9d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ];
  return (
      <>
  ...
  {/*    </div>*/}
  {/*</section>*/}
            <section className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 gap-4 w-full xl:x-16 lg:px-16 lg:py-16 md:px-16 md:py-16 sm:px-5 sm:py-12 xl:py-16 xl:mt-0 lg:mt-0 md:mt-0 sm:mt-[2px]">
                <h1 className={` xl:text-6xl lg:text-6xl md:text-5xl sm:text-4xl leading-snug w-[100%] font-bold  `}>Stay Updated With The Latest Ikeja FC News</h1>
            ...
            <section className="py-3">
                <p className="text-center text-lg font-semibold py-5">Official Sponsors of the Ikeja</p>
            ...
            <section id="video">
                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 w-full lg:gap-4 md:gap-4 sm:gap-0 xl:gap-4">
                    <div className="xl:p-10 lg:p-10 md:p-10 sm:p-5 ">
                        <h6 className={`text-sm font-semibold ${rowdies.className} text-primary`}>Tagline</h6>
                        <h2 className={`group-hover:underline xl:text-5xl md:text-4xl sm:text-3xl lg:text-5xl py-5 font-bold ${kanit_bold.className}`}>Stay Updated with Ikeja Video</h2>
